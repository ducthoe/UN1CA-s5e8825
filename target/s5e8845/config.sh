...
if [ "$TARGET_CODENAME" = "a55x" ]; then
    TARGET_NAME="Galaxy A55 5G"
    TARGET_CODENAME="a55x"
    # A536E
    # TARGET_FIRMWARE="SM-A536E/ZTO/357518816398424"
    # A536B
    TARGET_FIRMWARE="SM-A556E/SKZ/351351027166174"
...
TARGET_UNIFIED_NAME="s5e8845"
TARGET_SUPER_PARTITION_SIZE="9701615588"
TARGET_SUPER_GROUP_SIZE="9693226980"
...
if [ "$TARGET_CODENAME" = "a55x" ]; then
    ...
    TARGET_SSRM_CONFIG_NAME="siop_a55x_s5e8845"
fi
...
TARGET_DVFS_CONFIG_NAME="dvfs_policy_s5e8845_xx"
